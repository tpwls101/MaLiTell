...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((auth) -> auth
                .requestMatchers("/", "/user/join/**", "/login", "/oauth2/**", "/user/reissue", "/chat/**", "/user/exists/**", "/auth/**", "/ws-stomp/**", "/getCounselorList", "/getCounselor/**", "/community/getBoardList/**", "/gathering/getBoardList/**", "/overComing/getBoardList/**", "/gathering/view/**", "/community/view/**").permitAll()
